...
[
  {
    ...
    description: {
      english: [
        {
          text: `commonly called itik, is the most popularly raised locally. Although smaller than imported breeds, they are good layers and non-sitters. Their eggs are large.
      ...
      tagalog: [
        {
          text: `karaniwang tinatawag na itik, ay ang pinakasikat na pinalaki sa lokal. Bagaman mas maliit kaysa sa mga imported na lahi, ang mga ito ay mahusay na mga layer at hindi nakaupo. Malaki ang kanilang mga itlog.

          Ang mga nangingibabaw na kulay nito ay itim at kulay abo. Ang iba ay bared (bulek), ang iba ay kayumanggi o may puting balahibo na may halong itim/berde. Ang mga lalaki ay may mas magaspang na ulo at mas mabibigat na katawan kaysa sa mga babae. Ang mga lalaki ay naglalabas ng matinis na mataas na tunog. Mayroon silang mga kulot na balahibo sa ibabaw ng kanilang mga buntot. Ang mga babae ay naglalabas ng mababang tunog ng pagyanig. Ang kanilang mga balahibo sa buntot ay nakahiga patag o malapit sa mga katawan.`,
        },
      ],
    },
    waysToRaise: {
  ...
  },
  {
      ...
      english: [
        {
          ...
          Young pigs can be weaned from their mothers after two or three months. They will continue to grow well into their adult years, but it is important to socialize them while they are young.

          Adult Pigs
          Once a pig reaches sexual maturity, it is considered an adult. This age can vary greatly. It usually happens between 2 to 5 years of age, but it will depend on the individual pig and specific breed of pig. `,
        },
      ],
      tagalog: [
        {
          text: `Kahit na ang bawat species ay may sariling natatanging hugis at sukat, lahat sila ay may ilang pagkakatulad. Ang mga matatanda ay karaniwang may malalaking ulo na may mga pahabang nguso na may pabilog na dulo. Ang bawat isa sa apat na paa ay may apat na daliri ng paa, dalawang mas malalaking pangunahing daliri at dalawang mas maliliit na daliri. Bilang karagdagan, ang pinakamalaking alagang baboy sa talaan ay umabot ng higit sa 2,500 lbs at ang pinakamalaking ligaw na baboy ay umabot ng hanggang 600 lbs.

          Ang mga batang baboy ay maaaring ihiwalay sa kanilang mga ina pagkatapos ng dalawa o tatlong buwan. Patuloy silang lalago hanggang sa kanilang mga taong nasa hustong gulang, ngunit mahalagang makihalubilo sila habang sila ay bata pa.

          Mga Baboy na nasa hustong gulang
          Kapag ang baboy ay umabot na sa sekswal na kapanahunan, ito ay itinuturing na isang may sapat na gulang. Ang edad na ito ay maaaring mag-iba nang malaki. Karaniwan itong nangyayari sa pagitan ng 2 hanggang 5 taong gulang, ngunit ito ay depende sa indibidwal na baboy at partikular na lahi ng baboy.`,
        },
      ],
    },
    waysToRaise: {
      english: [
        {
          text: `When raising a grower pig, you will need to purchase a weaned piglet from a farm or breeder. These piglets are usually about 8 weeks old (50-60lbs) and have just been weaned from their mother's milk. Finishing the pig will take about 4-6 months so the best time to get started is early spring-mid summer.
      ...
      tagalog: [
        {
          text: `Kapag nag-aalaga ng grower na baboy, kakailanganin mong bumili ng awat na biik mula sa isang sakahan o breeder. Ang mga biik na ito ay karaniwang mga 8 linggo ang gulang (50-60lbs) at kalalabas pa lamang sa gatas ng kanilang ina. Ang pagtatapos ng baboy ay aabutin ng humigit-kumulang 4-6 na buwan kaya ang pinakamainam na oras upang magsimula ay ang unang bahagi ng tagsibol-kalagitnaan ng tag-init.

          Pinakamahusay na Mga Kasanayan sa Pag-aanak na Dapat Pagtibayin sa mga Nayon

          Pinakamahusay na baboy breeding pruchees inangkop sa villagee. ( Pagpapalitan ng baboy-ramo
          sa pagitan ng mga nayon / mga magsasaka.)
          Para sa crossbreeding lalaking biik na ipinagpalit sa pagitan ng mga nayon. Taun-taon breeding
          Ang lalaki ay dapat palitan ng hindi nauugnay na kawan upang maiwasan ang mga problema sa inbreeding.`,
        },
      ],
    },
    foods: {
      english: [
        {
          text: `They eat different mixtures of feed as they grow. The bulk of their diet comes from corn and soybeans. Corn provides energy and soybeans provide protein. They also eat other grains like wheat and sorghum.
          Farmers may add supplements to ensure their hogs get necessary nutrients.  Young pig should be fed commercial grade pig pellets or food, hay, and fresh vegetables. `,
        },
      ],
      tagalog: [
        {
          text: `Kumakain sila ng iba't ibang pinaghalong feed habang lumalaki sila. Ang karamihan ng kanilang diyeta ay mula sa mais at soybeans. Ang mais ay nagbibigay ng enerhiya at ang soybean ay nagbibigay ng protina. Kumakain din sila ng iba pang butil tulad ng trigo at sorghum.
          Ang mga magsasaka ay maaaring magdagdag ng mga suplemento upang matiyak na ang kanilang mga baboy ay makakakuha ng mga kinakailangang sustansya. Ang batang baboy ay dapat pakainin ng commercial grade pig pellets o pagkain, dayami, at sariwang gulay.`,
        },
      ],
    },
    lifeSpan: {
    ...
    levelOfDiffucltyOfRaising: {
      english: [
        {
          text: `The major challenges to the pig industry are inadequate slaughter facilities, unorganized marketing, inadequate supply of breeding stock, high price of feeds, as well as, low quality feeds.
          Size. Most owners will buy pet breed pigs when they are much smaller than their final weight and dimensions. Aggression and behaviour problems,Bylaw,Feeding`,
        },
      ],
      tagalog: [
        {
          text: `Ang mga pangunahing hamon sa industriya ng baboy ay hindi sapat na mga pasilidad ng pagpatay, hindi organisadong marketing, hindi sapat na supply ng breeding stock, mataas na presyo ng mga feed, gayundin, mababang kalidad ng mga feed.
          Sukat. Karamihan sa mga may-ari ay bibili ng mga alagang baboy na lahi kapag sila ay mas maliit kaysa sa kanilang huling timbang at sukat. Mga problema sa pagsalakay at pag-uugali, Batas, Pagpapakain`,
        },
      ],
    },
    tips: {
  ...
  },
  {
    id: 3,
    name: '45days Chicken ',
    img: 'assets/img/home/livestock/chiken2.png',
    description: {
      english: [
        {
