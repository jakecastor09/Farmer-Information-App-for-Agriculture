    ...
    this._livestockData = [
      {
        ...
        icon: 'assets/img/details/livestocks/duck/icon.png',
        images: {
          descriptionImg: 'assets/img/details/livestocks/duck/image.png',
        },
        item1: {
          title: 'Description',
          english:
          ...
          filipino:
            'karaniwang tinatawag na itik, ay ang pinakasikat na pinalaki sa lokal. Bagaman mas maliit kaysa sa mga imported na lahi, ang mga ito ay mahusay na mga layer at hindi nakaupo. Malaki ang kanilang mga itlog.Ang mga nangingibabaw na kulay nito ay itim at kulay abo. Ang iba ay bared (bulek), ang iba ay kayumanggi o may puting balahibo na may halong itim/berde. Ang mga lalaki ay may mas magaspang na ulo at mas mabibigat na katawan kaysa sa mga babae. Ang mga lalaki ay naglalabas ng matinis na mataas na tunog. Mayroon silang mga kulot na balahibo sa ibabaw ng kanilang mga buntot. Ang mga babae ay naglalabas ng mababang tunog ng pagyanig. Ang kanilang mga balahibo sa buntot ay nakahiga patag o malapit sa mga katawan.',
        },
        item2: {
          title: 'Ways To Raise',
          english:
          ...
          filipino:
            'free range scheme, na siyang tradisyonal na paraan ng pagpapalaki ng mga katutubong itik. Sa ganitong pamamaraan, ang mga itik ay pinahihintulutang manginain at mag-scavenge sa mga bagong ani na palayan. Ang mga palayan ay mayaman sa mga feed ng itik tulad ng rice hull, snails, buto, damo, isda, at mga insekto. Sa ilalim ng free-range scheme, isang pansamantalang kanlungan at bakod na ginawa gamit ang mga fishnet ay ibinibigay upang payagan ang mga itik na makapagpahinga sa hapon. Ang kanlungan ay nagsisilbi ring pugad at nagbibigay ng proteksyon mula sa mga ligaw na hayop. Ang pamamaraang ito ay nagpapahintulot sa magsasaka ng pato na makatipid sa mga feed at pabahay. Ito rin ang sikat na pamamaraan na ginagamit para sa pagpapalaki ng mga itik isa hanggang limang buwang gulang.\nConfinement system gamit ang duck house (kamalig). Sa pamamaraang ito, ang mga itik ay binibigyan ng balanseng diyeta na kinabibilangan ng mga formulated feed at malinis na inuming tubig, tamang espasyo sa sahig, mga feeding space, at iba pang mga kinakailangan para sa pagpapanatili, paglaki, at pag-unlad, at para sa produksyon ng itlog.',
        },
        item3: {
          title: 'Foods',
          english:
            'should be fed with natural, local feeds such as empty grains (rice), rice and corn bran, ipil-ipil leaves, golden snails, banana trunks, worms, etc.',

          filipino:
            'dapat pakainin ng natural, lokal na mga feed tulad ng walang laman na butil (bigas), palay at corn bran, dahon ng ipil-ipil, golden snails, banana trunks, uod, atbp.',
        },
        item4: {
          title: 'Life Span',
          english:
            'Native ducks are not as long-lived as geese. The average life span of a native duck is 5 to 10 years.',

          filipino:
            'Ang mga katutubong pato ay hindi kasing haba ng buhay ng mga gansa. Ang average na tagal ng buhay ng isang katutubong pato ay 5 hanggang 10 taon.',
        },
        item5: {
          title: 'Level of Difficulty of Raising',
          english:
            'Ducks are messy. If contained continually within a specific area they will, in time, turn it to mud. Ducks require plenty of fresh water for cleaning and staying healthy. Water needs changing regularly to avoid disease.',

          filipino:
            'Ang mga itik ay magulo. Kung patuloy na nakapaloob sa loob ng isang partikular na lugar, sa kalaunan, gagawing putik. Ang mga itik ay nangangailangan ng maraming sariwang tubig para sa paglilinis at pananatiling malusog. Kailangang regular na magpalit ng tubig upang maiwasan ang sakit.',
        },
        item6: {
          title: 'Tips',
          english:
            'provide them with an unlimited source of clean and fresh water.\nEach duck will typically require 2 to 3 square feet of floor area to live comfortably.\nThe waterers and feeders should be checked regularly to ensure that they are operating correctly and not leaking or spilling liquids.\nDucks can eat a variety of foods, They live on bugs, snails, fungus, kitchen trash, rice, and other kitchen waste\nAlways remain in touch with the local veterinarian to ensure they are properly immunized at the appropriate time.',

          filipino: `bigyan sila ng walang limitasyong mapagkukunan ng malinis at sariwang tubig.\nAng bawat pato ay karaniwang mangangailangan ng 2 hanggang 3 talampakang parisukat ng lawak ng sahig upang mabuhay nang kumportable.\nAng mga waterer at feeder ay dapat na regular na suriin upang matiyak na ang mga ito ay gumagana nang tama at hindi tumutulo o tumatapon ng mga likido.\nMaaaring kumain ang mga itik ng iba't ibang pagkain, Nabubuhay sila sa mga surot, kuhol, halamang-singaw, basura sa kusina, bigas, at iba pang basura sa kusina\nPalaging makipag-ugnayan sa lokal na beterinaryo upang matiyak na sila ay nabakunahan nang maayos sa naaangkop na oras.`,
        },
      },
      {
        id: 2,
        ...
        icon: 'assets/img/details/livestocks/pig/icon.png',
        images: {
          descriptionImg: 'assets/img/details/livestocks/pig/image.png',
        },
        item1: {
          title: 'Description',
          english:
      ...
      },
      {
        ...
        icon: 'assets/img/details/livestocks/chicken/icon.png',
        images: {
          descriptionImg: 'assets/img/details/livestocks/chicken/image.png',
        },
        item1: {
          title: 'Description',
          english:
        ...
        item2: {
          ...
          filipino:
            'Ang stock ay dapat bilhin mula sa isang maaasahang hatchery o dealer kung saan ang mga parent stock ay maayos na nakalagay at maayos na pinamamahalaan.\nPumili/bumili lamang ng malulusog na sisiw (i.e. tuyo, malalambot na balahibo, matingkad na mata, at alerto at aktibong hitsura; libre sa mga sakit, at abnormalidad; ang mga sisiw ay dapat magkaroon ng pare-parehong laki at kulay; at sa kaso ng mga broiler chicks, ito ay dapat na mas kaunti. higit sa 33 g. sa araw na gulang)\nPiliin ang mga may mataas na livability at mabilis magtanim.',
        },
        item3: {
          title: 'Foods',
          english:
          ...
          filipino:
            'Pakanin ang iyong mga manok ng broiler na may booster at grower feed na broiler sa unang limang linggo. Pagkatapos ay bigyan sila ng broiler finisher. Ang mga commercial broiler feed ay naglalaman ng mga sangkap na nagpapabilis sa paglaki ng mga manok.',
        },
        item4: {
          title: 'Life Span',
          english:
            'Within industrial agriculture scenarios, however, the lives of broiler chickens are cut drastically short. Birds can be slaughtered anywhere from 21 days to 170 days old. The typical slaughter age is 47 days, and  slaughter age is 42 days.',

          filipino:
            'Sa loob ng mga sitwasyong pang-industriya sa agrikultura, gayunpaman, ang buhay ng mga manok na broiler ay napakaikli. Maaaring katayin ang mga ibon kahit saan mula 21 araw hanggang 170 araw ang edad. Ang karaniwang edad ng pagpatay ay 47 araw, at ang edad ng pagpatay ay 42 araw.',
        },
        item5: {
          title: 'Level of Difficulty of Raising',
          english: '',
        ...
        item6: {
          title: 'Tips',
          english: `You need to give anti-stress medication to your chickens two to five days before and after they move out of the cage for rearing.\nWhen it's summer, your broiler chickens are likely to reduce their appetite due to the hot weather. You can give them wet food or you can make ways to lower the temperature, such as spraying the roof and around the cage with water.`,

          filipino:
            'Kailangan mong bigyan ng anti-stress na gamot ang iyong mga manok dalawa hanggang limang araw bago at pagkatapos nilang umalis sa kulungan para sa pag-aalaga.\nKapag tag-araw, ang iyong mga manok na broiler ay malamang na mabawasan ang kanilang gana dahil sa mainit na panahon. Maaari mo silang bigyan ng basang pagkain o maaari kang gumawa ng mga paraan upang mapababa ang temperatura, tulad ng pag-spray ng tubig sa bubong at sa paligid ng hawla.',
        },
      },
    ];
  }
